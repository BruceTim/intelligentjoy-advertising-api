package com.intelligentjoy.advertising.api.web.config.pay;
...
import com.intelligentjoy.advertising.api.web.config.pay.handlers.AliPayMessageHandler;
import com.intelligentjoy.advertising.api.web.config.pay.handlers.WxPayMessageHandler;
import com.intelligentjoy.advertising.api.web.config.pay.interceptor.AliPayMessageInterceptor;
...
//        merchants.jdbc().template(jdbcTemplate);
        ...
        merchants.inMemory()
                ...
                .inputCharset("utf-8")
                .notifyUrl("http://pay.egzosn.com/payBack1")
                .returnUrl("http://pay.egzosn.com/payBack1")
                ...
                .notifyUrl("http://pay.egzosn.com/payBack2")
                .returnUrl("http://pay.egzosn.com/payBack2")
                .inputCharset("utf-8")
                .signType("MD5")
                //设置请求相关的配置
